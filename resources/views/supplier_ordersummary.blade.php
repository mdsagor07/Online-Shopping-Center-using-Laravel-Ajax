            ...
            <div class="col-lg-8 col-xl-6">
              <div class="card border-top border-bottom border-3" style="border-color: #f37a27 !important;">
                <div class="card-body p-5">
                  ...
                  <div class="col mb-3">
                    <p class="small text-muted mb-1 font-weight-bold">Invoice no</p>
                    <p>{{ $invoice }}</p>
                  </div>
      
                  <div class="row">
                    <div class="col mb-3">
                      <p class="small text-muted mb-1 font-weight-bold">Supplier Name:</p>
                      <p> {{ $supplier_name }}</p>
                    </div>
                    <div class="col mb-3">
                      <p class="small text-muted mb-1 font-weight-bold">Supplier Phone:</p>
                      <p> {{ $supplier_phone }}</p>
                    </div>
                    <div class="col mb-3">
                      <p class="small text-muted mb-1 font-weight-bold">Order no</p>
                      <p>{{ $order }}</p>
